...
import cn.edu.gdaib.fulongnews.adapter.TourRecyclerAdapter;
...
public class FragmentHomeTour extends Fragment {
    ...
    private TourRecyclerAdapter mRecyclerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tour_home, container, false);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.home_tour_recycler);
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.home_tour_swipe_refresh);
        initView();//初始化
        return view;
    }
    ...
    private void initView() {
        mRecyclerAdapter = new TourRecyclerAdapter(getContext(), TourHttpRequest.getData());
        ...
        mRecyclerAdapter.setOnItemClickListener(new RecyclerItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                String url = TourHttpRequest.getData().get(0).getResult().get(position).getUrl();
                Intent intent = new Intent(getActivity(), NewsDetailActivity.class);
                intent.putExtra("HtmlUrl", url);
                intent.putExtra("ToolbarTitle", "旅游");
    ...
    private void loadMoreData () {
        ...
        tempTotal = TourHttpRequest.getData().get(0).getResult().size();
