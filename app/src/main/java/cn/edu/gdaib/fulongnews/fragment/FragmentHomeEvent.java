...
import cn.edu.gdaib.fulongnews.adapter.EventRecyclerAdapter;
...
public class FragmentHomeEvent extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mRecyclerView = (RecyclerView) view.findViewById(R.id.home_event_recycler);
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.home_event_swipe_refresh);
        initView();//初始化
        return view;
    }
    ...
    private void initView() {
        mRecyclerAdapter = new EventRecyclerAdapter(getContext(), EventHttpRequest.getData());
        ...
        mRecyclerAdapter.setOnItemClickListener(new RecyclerItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                String url = EventHttpRequest.getData().get(0).getResult().get(position).getUrl();
                Intent intent = new Intent(getActivity(), NewsDetailActivity.class);
                intent.putExtra("HtmlUrl", url);
                intent.putExtra("ToolbarTitle", "国际");
    ...
    private void loadMoreData () {
        ...
        tempTotal = EventHttpRequest.getData().get(0).getResult().size();
