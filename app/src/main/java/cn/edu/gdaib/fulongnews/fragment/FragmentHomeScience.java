...
import cn.edu.gdaib.fulongnews.adapter.ScienceRecyclerAdapter;
...
public class FragmentHomeScience extends Fragment {

    private RecyclerView mRecyclerView;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private ScienceRecyclerAdapter mRecyclerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_science_home, container, false);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.home_science_recycler);
        mSwipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.home_science_swipe_refresh);
        initView();//初始化
        return view;
    }
    ...
    private void initView() {
        mRecyclerAdapter = new ScienceRecyclerAdapter(getContext(), ScienceHttpRequest.getData());
        ...
        mRecyclerAdapter.setOnItemClickListener(new RecyclerItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                String url = ScienceHttpRequest.getData().get(0).getResult().get(position).getUrl();
                Intent intent = new Intent(getActivity(), NewsDetailActivity.class);
                intent.putExtra("HtmlUrl", url);
                intent.putExtra("ToolbarTitle", "科技");
    ...
    private void loadMoreData() {
        ...
        tempTotal = ScienceHttpRequest.getData().get(0).getResult().size();
